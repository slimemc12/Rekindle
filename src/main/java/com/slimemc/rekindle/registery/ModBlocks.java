...
public class ModBlocks {
    ...
    static {
        STEEL_BLOCK = register("steel_block", new Block(FabricBlockSettings.of(Material.METAL).requiresTool().strength(5.0f, 15.0f).sounds(BlockSoundGroup.METAL)));
        STEEL_TRAPDOOR = register("steel_trapdoor", new RekindleTrapdoorBlock(FabricBlockSettings.of(Material.METAL).requiresTool().strength(3.0F, 12.0f).sounds(BlockSoundGroup.METAL).nonOpaque()));
        STEEL_DOOR = register("steel_door", new RekindleDoorBlock(FabricBlockSettings.of(Material.METAL).requiresTool().strength(5.0F, 12.0F).sounds(BlockSoundGroup.METAL).nonOpaque()));
        STEEL_BARS = register("steel_bars", new RekindlePaneBlock(FabricBlockSettings.of(Material.METAL).requiresTool().strength(5.0F, 13.0F).sounds(BlockSoundGroup.METAL).nonOpaque())) ;
        ...
        ANDESITE_LARGE_BRICKS = register("andesite_large_bricks", new Block(FabricBlockSettings.of(Material.STONE).requiresTool().strength(2.2f,7.0f).sounds(BlockSoundGroup.STONE)));
        ANDESITE_FANCY_BRICKS = register("andesite_fancy_bricks", new Block(FabricBlockSettings.of(Material.STONE).requiresTool().strength(2.2f,7.0f).sounds(BlockSoundGroup.STONE)));
        ANDESITE_TILES = register("andesite_tiles", new Block(FabricBlockSettings.of(Material.STONE).requiresTool().strength(2.2f,7.0f).sounds(BlockSoundGroup.STONE)));
        ANDESITE_PAVING = register("andesite_paving", new Block(FabricBlockSettings.of(Material.STONE).requiresTool().strength(2.2f,7.0f).sounds(BlockSoundGroup.STONE)));
        ANDESITE_PILLAR = register("andesite_pillar", new PillarBlock(FabricBlockSettings.of(Material.STONE).requiresTool().strength(2.2f,7.0f).sounds(BlockSoundGroup.STONE)));
        DIORITE_BRICKS = register("diorite_bricks", new Block(FabricBlockSettings.of(Material.STONE).requiresTool().strength(2.2f,7.0f).sounds(BlockSoundGroup.STONE)));
        DIORITE_LARGE_BRICKS = register("diorite_large_bricks", new Block(FabricBlockSettings.of(Material.STONE).requiresTool().strength(2.2f,7.0f).sounds(BlockSoundGroup.STONE)));
        DIORITE_FANCY_BRICKS = register("diorite_fancy_bricks", new Block(FabricBlockSettings.of(Material.STONE).requiresTool().strength(2.2f,7.0f).sounds(BlockSoundGroup.STONE)));
        DIORITE_TILES = register("diorite_tiles", new Block(FabricBlockSettings.of(Material.STONE).requiresTool().strength(2.2f,7.0f).sounds(BlockSoundGroup.STONE)));
        DIORITE_PAVING = register("diorite_paving", new Block(FabricBlockSettings.of(Material.STONE).requiresTool().strength(2.2f,7.0f).sounds(BlockSoundGroup.STONE)));
        DIORITE_PILLAR = register("diorite_pillar", new PillarBlock(FabricBlockSettings.of(Material.STONE).requiresTool().strength(2.2f,7.0f).sounds(BlockSoundGroup.STONE)));
        GRANITE_BRICKS = register("granite_bricks", new Block(FabricBlockSettings.of(Material.STONE).requiresTool().strength(2.2f,7.0f).sounds(BlockSoundGroup.STONE)));
        GRANITE_LARGE_BRICKS = register("granite_large_bricks", new Block(FabricBlockSettings.of(Material.STONE).requiresTool().strength(2.2f,7.0f).sounds(BlockSoundGroup.STONE)));
        GRANITE_FANCY_BRICKS = register("granite_fancy_bricks",new Block(FabricBlockSettings.of(Material.STONE).requiresTool().strength(2.2f,7.0f).sounds(BlockSoundGroup.STONE)));
        GRANITE_TILES = register("granite_tiles", new Block(FabricBlockSettings.of(Material.STONE).requiresTool().strength(2.2f,7.0f).sounds(BlockSoundGroup.STONE)));
        GRANITE_PAVING = register("granite_paving", new Block(FabricBlockSettings.of(Material.STONE).requiresTool().strength(2.2f,7.0f).sounds(BlockSoundGroup.STONE)));
        GRANITE_PILLAR = register("granite_pillar", new PillarBlock(FabricBlockSettings.of(Material.STONE).requiresTool().strength(2.2f,7.0f).sounds(BlockSoundGroup.STONE)));
        LIMESTONE = register("limestone", new Block(FabricBlockSettings.of(Material.STONE).requiresTool().strength(2.2f,7.0f).sounds(BlockSoundGroup.STONE)));
        LIMESTONE_WALL= register("limestone_wall", new WallBlock(FabricBlockSettings.of(Material.STONE).requiresTool().strength(2.0f,6.0f).sounds(BlockSoundGroup.STONE)));
        POLISHED_LIMESTONE = register("polished_limestone", new Block(FabricBlockSettings.of(Material.STONE).requiresTool().strength(2.2f,7.0f).sounds(BlockSoundGroup.STONE)));
        POLISHED_LIMESTONE_WALL = register("polished_limestone_wall", new WallBlock(FabricBlockSettings.of(Material.STONE).requiresTool().strength(2.0f,6.0f).sounds(BlockSoundGroup.STONE)));
        POLISHED_LIMESTONE_SLAB = register("polished_limestone_slab", new SlabBlock(FabricBlockSettings.of(Material.STONE).requiresTool().strength(2.2f,7.0f).sounds(BlockSoundGroup.STONE)));
        LIMESTONE_SLAB = register("limestone_slab", new SlabBlock(FabricBlockSettings.of(Material.STONE).requiresTool().strength(2.2f,7.0f).sounds(BlockSoundGroup.STONE)));
        LIMESTONE_STAIRS = register("limestone_stairs", new RekindleStairsBlock(ModBlocks.LIMESTONE.getDefaultState(), FabricBlockSettings.of(Material.STONE).requiresTool().strength(2.2f,7.0f).sounds(BlockSoundGroup.STONE)));
        POLISHED_LIMESTONE_STAIRS = register("polished_limestone_stairs", new RekindleStairsBlock(ModBlocks.POLISHED_LIMESTONE.getDefaultState(), FabricBlockSettings.of(Material.STONE).requiresTool().strength(2.2f,7.0f).sounds(BlockSoundGroup.STONE)));
        LIMESTONE_BRICKS = register("limestone_bricks", new Block(FabricBlockSettings.of(Material.STONE).requiresTool().strength(2.2f,6.0f).sounds(BlockSoundGroup.STONE)));
        LIMESTONE_LARGE_BRICKS = register("limestone_large_bricks", new Block(FabricBlockSettings.of(Material.STONE).requiresTool().strength(2.2f,7.0f).sounds(BlockSoundGroup.STONE)));
        LIMESTONE_FANCY_BRICKS = register("limestone_fancy_bricks", new Block(FabricBlockSettings.of(Material.STONE).requiresTool().strength(2.2f,6.5f).sounds(BlockSoundGroup.STONE)));
        LIMESTONE_TILES = register("limestone_tiles", new Block(FabricBlockSettings.of(Material.STONE).requiresTool().strength(2.2f,6.5f).sounds(BlockSoundGroup.STONE)));
        LIMESTONE_PAVING = register("limestone_paving", new Block(FabricBlockSettings.of(Material.STONE).requiresTool().strength(2.2f,7.0f).sounds(BlockSoundGroup.STONE)));
        ...
        //misc
        ALLOY_FURNACE = register("alloy_furnace", new AlloyFurnaceBlock(FabricBlockSettings.of(Material.METAL).requiresTool().strength(5.0f, 12.0f)
